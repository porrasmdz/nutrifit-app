    ...
    <AsyncPage>
      ...
      <section id="categories" class="mx-auto my-20 w-full py-20 text-center xl:w-4/5">
        <div class="text-left">
          ...
          <div
            class="flex flex-col items-center justify-center gap-4 md:flex-row lg:justify-between"
          >
            <CategoryCard
      ...
      <section id="courses" class="mx-auto my-20 w-full py-20 text-center xl:w-4/5">
        <div class="text-left">
          ...
          <div
            class="flex flex-col items-center justify-between gap-4 md:flex-row lg:justify-between"
          >
            <CourseCard
            ...
            >
              <template #cover>
                <div class="h-50 bg-red-300">
                  <img
                    class="object-fit"
                    src="https://files.cults3d.com/uploaders/15529773/illustration-file/fc1c0ead-195b-426e-b2f3-46d7ee150a80/s-l400.jpg"
                    alt=""
                  >
                </div>
              </template>
            ...
            >
              <template #cover>
                <div class="h-50 bg-red-300">
                  <img
                    class="object-fit"
                    src="data:image/jpeg;base64," alt=""
                  >
                </div>
              </template>
            </NCard>
